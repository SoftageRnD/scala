...
@State(Scope.Thread)
public class ContainsHashSetBenchmarkState extends HashSetBenchmarkState {

    public Map<Integer, scala.collection.mutable.HashSet<Integer>> scalaHashSetMap;

    public Map<Integer, scala.collection.mutable.experimental.HashSet<Integer>> newHashSetMap;

    @Setup(Level.Trial)
    public void setUp() {
        scalaHashSetMap = new HashMap<Integer, scala.collection.mutable.HashSet<Integer>>();
